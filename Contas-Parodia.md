# O que são Contas de Parodia do X
...
Não pode se passar por alguém real com intenção de enganar

Paródia ≠ desinformação (quando há aviso claro)

Diferença importante

Paródia → humor + identificação clara
